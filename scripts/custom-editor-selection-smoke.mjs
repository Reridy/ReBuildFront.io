...
for(const token of ["dataset.advancedTool='move'","dataset.advancedTool='lasso'","const inside=","extract(true)","selection.points","drag.kind==='layer'","drag.kind==='selection'","key==='v'","key==='l'","e.key==='Delete'","e.key==='Escape'"])assert(js.includes(token),`missing ${token}`);
